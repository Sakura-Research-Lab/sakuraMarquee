...
- "Now Listening" menu (track, album and artist via MPRIS) (WIP)
...
- To load on RetroPie startup, add the following line to "/opt/retropie/configs/all/autostart.sh": ``` python3 /home/pi/sakuraMarquee.py & ```
